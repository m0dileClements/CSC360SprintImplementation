...
public class ArrayListConverter extends Converter
{
	...
	public void loadData(Main main){
		...
		for (int i = 0; i < classes.size(); i++) {
			...
			Room room = new Room(classes.get(i)[3], Integer.parseInt(classes.get(i)[4]));
			...
			ClassInstance fullClass = new ClassInstance(course, term, instructor, classTime, room, dept);
